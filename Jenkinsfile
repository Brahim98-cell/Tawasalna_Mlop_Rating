...
pipeline{
    ...
    environment {
             DOCKER_IMAGE_transaction = 'brahim98/transaction-prediction:v1.0.5-dev'
...
*/
 ...
 stage('Build image ') {
                ...
                sh "docker build -t $DOCKER_IMAGE_transaction -f Dockerfile ."
      ...
      stage('Push image ') {
                steps {
                    script {
                        ...
                        sh "docker push $DOCKER_IMAGE_transaction"
